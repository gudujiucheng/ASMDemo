 ...
 */
public class SlowMethodRecordTransform extends HunterTransform {
    private Project project;


    public SlowMethodRecordTransform(Project project) {
        super(project);
        this.project = project;
        this.bytecodeWeaver = new SlowMethodRecordWeaver();
    }
